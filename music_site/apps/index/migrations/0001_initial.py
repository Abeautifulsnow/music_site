# Generated by Django 2.1.5 on 2019-04-14 14:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_date', models.DateTimeField(auto_now_add=True, verbose_name='日期')),
            ],
            options={
                'verbose_name': '评论表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dynamic_plays', models.IntegerField(default=0, verbose_name='播放次数')),
                ('dynamic_search', models.IntegerField(default=0, verbose_name='搜索次数')),
                ('dynamic_down', models.IntegerField(default=0, verbose_name='下载次数')),
            ],
            options={
                'verbose_name': '歌曲动态',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('song_name', models.CharField(max_length=50, verbose_name='歌曲名字')),
                ...
                ('song_label', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='index.Label', verbose_name='歌曲分类')),
            ],
            options={
                'verbose_name': '歌曲信息',
